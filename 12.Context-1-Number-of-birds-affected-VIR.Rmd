...
```{r context_number_birds_affected_processing_environment, warning=FALSE, message=FALSE}
library(bioRad)
library(ggplot2)
library(dplyr)
library(tidyr)
...
```{r output_bird_numbers, results='hold'}
...
paste0("Response assuming mean RCS of 11 cm^2: ", round(total_vir / 11), " birds.")
```
