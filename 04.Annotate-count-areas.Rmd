...
```{r load_waterbird_areas, message=FALSE, results='hold'}
...
```{r add_rasterized_areas_to_ppis}
...
```{r buffer_convex_hulls_with_interpoint_distance, fig.show='hold', results='hold', warning=FALSE, message=FALSE}
