...
generate_composites <- function(hrw_ppis, dhl_ppis, res) {
...
r <- parallel::mcmapply(function(resolution) generate_composites(hrw_ppis, dhl_ppis, res = resolution), resolution = c(500, 1000, 2000), mc.cores = 3)
```
