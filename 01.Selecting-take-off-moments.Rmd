...
pvol_hrw <- paste(pvol_folder, "RAD_NL62_VOL_NA_", hrw_dt_str, "_ODIM.h5", sep = "")
pvol_dhl <- paste(pvol_folder, "RAD_NL61_VOL_NA_", dhl_dt_str, "_ODIM.h5", sep = "")

save(pvol_hrw, pvol_dhl, file = "data/processed/pvol_selection.RData")
```
