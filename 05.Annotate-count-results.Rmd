...
species_lut <- build_species_lut(unique_species, datasetKey = "4dd32523-a3a3-43b7-84df-4cda02f15cf7", higherTaxonKey = 162310263)
species_lut
```
...
lhc %>%
  ...
  select(species, mean_weight, gbif_key) -> lhc
