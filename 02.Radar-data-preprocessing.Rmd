...
scan <- plot(pvol_hrw$scans[[1]], param = "DBZH", xlim = c(0, 180)) + theme_dark()
ggplotly(scan)
```
...
i = 1
plot(pvol_hrw$scans[[i]], param = "DBZH", xlim = c(0, 180)) + theme_dark() + 
...
plot(pvol_dhl$scans[[i]], param = "DBZH", xlim = c(0, 180)) + theme_dark() + 
