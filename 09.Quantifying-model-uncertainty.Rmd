...
cis <- lapply(Sys.glob("data/models/confints/modelci*")[2:1000], readRDS)
...
vars <- c("dist_radar", "total_biomass", "semiopen", "forests", "wetlands", "waterbodies", "agricultural", "dist_urban")
par(mfrow = c(2, 4))
lapply(vars, function(x) plot(modelci, which = x))
```
