...
pop_hrw <- focal(as(pop_density_rasterized_hrw, "Raster"), w = weights, fun = sum, pad = TRUE, padValue = 0)
pop_dhl <- focal(as(pop_density_rasterized_dhl, "Raster"), w = weights, fun = sum, pad = TRUE, padValue = 0)
```
